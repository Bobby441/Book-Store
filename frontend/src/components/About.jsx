    ...
    <section className='max-padd-container py-12 xl:py-24'>
      ...
      <div className='flexCenter flex-col gap-16 xl:gap-8 xl:flex-row'>
        ...
        <div className='flex-1'>
          <Title title1={'Unveiling Our '} title2={`Sotre's key features!`} titleStyles={'pb-10'} paraStyles={'!block'} />
          <div className='flex flex-col items-start gap-y-4'>
            <div className='flexCenter gap-x-4'>
              ...
              <div>
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi magnam debitis perspiciatis. Architecto?</p>
              </div>
            </div>
            <div className='flexCenter gap-x-4'>
              <div className='h-16 min-w-16 bg-secondaryOne flexCenter rounded-md'>
